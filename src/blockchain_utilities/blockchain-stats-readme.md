# Incognito Blockchain Stats

Incognito Blockchain Stats utlity exports daily statistics for the incognito blockchain from creation through current state.

## Usage:

See also the utility's help option. `incognito-blockchain-stats --help`
...
- `incognito-blockchain-stats > stats-$(date +'%Y-%m-%d').csv`
- `incognito-blockchain-stats | save-to-database.sh`
