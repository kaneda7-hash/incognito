# Bootstrappable Incognito Builds

This directory contains the files necessary to perform bootstrappable Incognito 
builds.
...
To build Incognito reproducibly with all default options, invoke the
...
repository](https://github.com/incognito-project/guix.sigs).
