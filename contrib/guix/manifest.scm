...
(define* (make-incognito-cross-toolchain  target
                                       #:key
...
desirable for building Incognito release binaries."
          ...
          ((string-contains target "-linux-gnu")
           (list
             ...
             (if (string-contains target "loongarch64")
               (make-incognito-cross-toolchain target #:base-libc glibc)
               (make-incognito-cross-toolchain target))))
