...
posted to #incognito-dev on irc.libera.chat).
...
- Users MUST NOT log feature requests, ideas, or suggestions unrelated to Incognito code or Incognito's dependency code or Incognito's potential/future dependency code or research which successfully implements Incognito.
...
- Maintainers SHOULD NOT merge their own patches unless they were added to the merge queue on irc and have at least 2 approvals from contributors OR unless urgent as defined by the Incognito Maintainers Team.
...
- The Incognito Core Team MUST act as Administrators to manage the set of project Maintainers.
